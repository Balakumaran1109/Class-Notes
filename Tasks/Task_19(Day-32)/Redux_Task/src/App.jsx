...
function App() {
  ...
  const inputDetails = useSelector((state) => state.quantity.details);

  useEffect(() => {
    dispatch(initialDetails(mobileDetails));
  }, []);
  ...
  return (
    <>
      {/* <div>{console.log(mobileDetails)}</div> */}
      <div>
                    ...
                    <div className="col text-center">
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => dispatch(handleIncrement({id : value.id}))}
                        >
                          Add
                        </button>
                        <button
                          ...
                          onClick={() => dispatch(handleDecrement({id : value.id}))}
                        >
                          Delete
                        </button>
                      </div>
