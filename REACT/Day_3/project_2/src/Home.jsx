...
function CartList({name, price, handleCartValue, click}) {
  ...
  return (
    ...
    <div class="col mb-5">
        ...
        <div>{name === "Special Item" || name === "Sale Item" ? <div class="badge bg-dark text-white position-absolute">
                    Sale
                  </div> : <div></div>}</div>
  <img src="https://dummyimage.com/450x300/dee2e6/6c757d.jpg" class="card-img-top" alt="..."></img>
  <div class="card-body p-4 text-center">
    <h5 class="card-title">{name}</h5>

    <div>{name === "Special Item" || name === "Popular Item" ? <div>
    ...
    {name === "Fancy Product" ?  <button type="button" class="btn btn-white btn-outline-dark">View options</button>
 : (handleCartValue ? <button onClick={click} type="button" class="btn btn-white btn-outline-dark">Remove from cart</button> :  <button onClick={click} type="button" class="btn btn-white btn-outline-dark">Add to cart</button>)}
    ...
    <>
      ...
      <footer className="bg-dark py-5">
        <div className="container">
            <p className="text-white text-center">Copyright © Your Website 2023</p>
        </div>
      </footer>
    </>
  );
